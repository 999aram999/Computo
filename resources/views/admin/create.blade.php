...
@section('content')
    ...
    <h1 class="text-5xl text-center pt-24"> Add Preguntas </h1>
    <div class="block mx-auto my-12 p-8 bg-white w-1/3 border border-gray-100
    rounded-lg shadow-xl">
        <form action="/PreguntasRespuestas/public/admin/create" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            value="Add Imagen">
            <div class="">
                <h1 class="text-3xl text-center dont-bold">Registrar Pregunta</h1>
