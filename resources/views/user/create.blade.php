...
@section('content')
    ...
    <h1 class="text-5xl text-center pt-24"> Agregar libro a mi perfil de BooxBook</h1>
    <div class="block mx-auto my-12 p-8 bg-white w-1/3 border border-gray-100
    rounded-lg shadow-xl">
        <form action="/Biblioteca/public/user/create" method="POST" enctype="multipart/form-data">
            @csrf
